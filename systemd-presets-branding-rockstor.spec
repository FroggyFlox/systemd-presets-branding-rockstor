...
# everything that must be enabled only in Rockstor built on openSUSE
install -m644 %{SOURCE1}  %{buildroot}%{_prefix}/lib/systemd/system-preset/90-default-Rockstor.preset
